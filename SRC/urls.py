...
urlpatterns = [
    ...
    url(r'^learner_dashboard/',all_courses,name='learner_dashboard'),
    ...
    re_path('learner_preview_course/(?P<course_id>\d+)', learner_preview_course, name='learner_preview_course'),
