var app = angular.module("browse_courses", ['ngRateIt', 'ngFitText', 'infinite-scroll', 'slick']);
...
app.controller('myCtrl', function($scope, $timeout, $http, $q) {
	...
	$scope.add_to_cart = function(){
		...
		function successCallback(response){
			...
			swal("Course Added To Your Cart", "Please check your cart!", "success");
		};
		function errorCallback(error){
			console.log(error);
